...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadSound(url) {
        ...
        try {
            ...
            // Note: This resume might not always work without a user gesture, depending on browser policy.
    ...
    // Load and play the sound effect when the DOM is ready
    loadSound('/que comience el juego.mp3').then(success => {
        if (success) {
            playSound(); // Attempt to play immediately after loading
        }
    });
